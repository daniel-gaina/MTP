...
\item ind. step: $\Gamma\cup \{ \Forall{\E} \Exists{\Z} \Read(\Z,\lt) \If (\E \In \lt)=\True  \}\vdash_{\Sig[\lt,\e]} \Forall{\E}  \Exists{\Z} \Read(\Z,\lt\comp\e) = \E\If (\E\In \lt\comp\e) = \True $,

where $\e\colon \to \Elt$ and $\lt\colon\to \List$ 
\end{itemize}
\end{document}